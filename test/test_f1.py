...
class TestF1(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.shp = cls.temp_result_dir / "result_f1/biotope3_WGS_f1.shp"
        cls.csv = cls.temp_result_dir / "result_f1/biotope3_WGS_f1.csv"
    ...
    def test_shp_correct(self):
        ...
        answer = arcutils.shp_to_df("test/answer/result_f1/biotope3_WGS_f1.shp")
        self.assertTrue(result.equals(answer))
    ...
    def test_csv_correct(self):
        ...
        answer = pd.read_csv("test/answer/result_f1/biotope3_WGS_f1.csv")
        self.assertTrue(result.equals(answer))
